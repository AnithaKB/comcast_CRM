...
public class CreateOrganizationWithIndustriesTest {
	...
	public static void main(String[] args) throws Throwable {
      ...
      FileInputStream fis1=new FileInputStream("D:\\ANITHA\\OFFICIAL\\TEK PYRAMID\\ADVANCE SELENIUM\\Book1.xlsx");
		...
		WebElement indDropdwn = driver.findElement(By.xpath("//select[@name=\"industry\"]"));
		Select sel=new Select(indDropdwn);
		sel.selectByVisibleText(industry);
		
		WebElement typDropdwn = driver.findElement(By.xpath("//select[@name=\"accounttype\"]"));
		Select sel2=new Select(typDropdwn);
